...
public class Variable_Q2 {
    int id;
    String name;
    // use 'this' key word declare to local variable
    public void ConstructorVariable_Q2(int id, String name) {
        this.id = id;
        this.name = name;
        System.out.print(id);
        System.out.println(" " + name);
    }
    // use method rule - no return type with no parameter
    public void display() {
        int id1 = 102;
        String name1 = "Prime";
    ...
    public static void main(String[] args) {
        Variable_Q2 obj1 = new Variable_Q2();
        Variable_Q2 obj2 = new Variable_Q2();
        obj1.ConstructorVariable_Q2(101, "Setu Patel");
        obj2.display();
    }
}
